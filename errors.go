...
var errorMessages = map[string]string{
	...
	"ENTITY_BOUNDS_INVALID":               "A specified [entity offset or length](/api/entities#entity-length) is invalid, see [here &raquo;](https://core.telegram.org/api/entities#entity-length) for info on how to properly compute the entity offset/length.",
	...
	"FLOOD_WAIT_X":                          "A wait of %v seconds is required before calling the method",
	...
	"STORY_SEND_FLOOD_MONTHLY_X":            "You've hit the monthly story limit as specified by the stories_sent_monthly_limit_* client configuration parameters: wait for the specified number of seconds before posting a new story.",
	"STORY_SEND_FLOOD_WEEKLY_X":             "You've hit the weekly story limit as specified by the stories_sent_weekly_limit_* client configuration parameters: wait for the specified number of seconds before posting a new story.",
	...
	"PREMIUM_SUB_ACTIVE_UNTIL_X":            "You already have a premium subscription active until unixtime %d .",
