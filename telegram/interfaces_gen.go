...
type InputStorePaymentStarsTopup struct {
	...
	Currency         string
	Amount           int64
	SpendPurposePeer InputPeer `tl:"flag:0"`
}
...
type MessageActionSetChatTheme struct {
	Theme ChatTheme // The emoji that identifies a chat theme
}
